...
def txt_to_regional_indicator(string: str) -> str:
    """
...
def regional_indicator_to_letter(regional_indicator: str) -> str:
    ...
    """
    assert (
        regional_indicator in _regional_indicators_unicode
    ), f"Regional indicator {regional_indicator} not in regional indicator unicode list"
    return _letters[_regional_indicators_unicode.index(regional_indicator)]


def regional_indicator_to_txt(regional_indicator_string: str) -> str:
    """
    ...
    return "".join(
        [
            regional_indicator_to_letter(regional_indicator)
            for regional_indicator in regional_indicator_string
        ]
    )
